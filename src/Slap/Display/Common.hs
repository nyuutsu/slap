...
-- Both fields are 'Text': the label set across formats is open and proliferates,
-- so a closed sum or newtype wouldn't pay for the constructor surface or wrapping ceremony;
